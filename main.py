...
video_update_args.add_argument("name", type=str, help="Please send a name")
video_update_args.add_argument("views", type=int, help="Please send a views")
video_update_args.add_argument("likes", type=int, help="Please send a likes")
